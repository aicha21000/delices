...
export const products: Product[] = [
    ...
    },
    {
        ...
        description: 'La fraîcheur du citron dans une bouchée délicate. Un glaçage acidulé qui réveille les papilles, enrobant un biscuit tendre. L\'équilibre parfait entre le sucre et le zeste pour une pause gourmande.',
        priceUnit: 1.20,
        priceBox: 35.00,
        image: '/images/gateaux-citron.jpg',
        category: 'gateaux',
    },
    {
        id: '4',
    ...
    },
    {
        ...
        description: 'L\'emblème de la pâtisserie traditionnelle. De la semoule fine dorée au four ou frite, fourrée d\'une pâte de dattes onctueuse parfumée à la cannelle et aux clous de girofre, le tout enrobé de miel.',
        priceUnit: 1.20,
        priceBox: 38.00,
